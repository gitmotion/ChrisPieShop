using ChrisPieShop.TagHelpers;
using Microsoft.AspNetCore.Razor.TagHelpers;
using Moq;

namespace ChrisPieShopTests.TagHelpers
{
    public class EmailTagHelperTests
    {
        ...
        {
            // Arrange
            EmailTagHelper emailTagHelper = new EmailTagHelper() { Address = "test@tester.com", Content = "Email" }; ;
            ...
            Assert.Equal("mailto:test@tester.com", tagHelperOutput.Attributes[0].Value);
        }
    }
}
